      ...
      <div className="bg-gray-800 rounded-lg shadow-2xl p-8 w-full max-w-lg transform transition-all scale-95 opacity-0 animate-fade-in-scale">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-yellow-400 font-serif">
            {skillToEdit ? "Editar Poder" : "Adicionar Poder"}
          </h2>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end space-x-4 pt-2">
            ...
            <button
              type="submit"
              className="py-2 px-4 bg-yellow-500 hover:bg-yellow-600 rounded-md text-gray-900 font-semibold transition"
            >
